        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="minConfidence">Min Signal Confidence (0-1)</Label>
                <Input id="minConfidence" type="number" step="0.05" {...form.register("minConfidence")} className="font-mono" />
              </div>
              <div className="space-y-2">
