...
export const getClosePositionUrl = (symbol: string,) => {
  ...
  return `/api/positions/${symbol}`
}

/**
 * @summary Close an open position
 */
export const closePosition = async (symbol: string, options?: Parameters<typeof customFetch>[1]): Promise<ClosePositionResponse> => {

  return customFetch<ClosePositionResponse>(getClosePositionUrl(symbol),
  {
    ...options,
    method: 'DELETE'
...
export const getClosePositionMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof closePosition>>, TError,{symbol: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof closePosition>>, TError,{symbol: string}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof closePosition>>, {symbol: string}> = (props) => {
          const {symbol} = props ?? {};
 ...
 * @summary Close an open position
 */
export const useClosePosition = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof closePosition>>, TError,{symbol: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getGetSignalByIdQueryOptions = <TData = Awaited<ReturnType<typeof getSignalById>>, TError = ErrorType<ErrorResponse>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSignalById>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetSignalById<TData = Awaited<ReturnType<typeof getSignalById>>, TError = ErrorType<ErrorResponse>>(
 ...
 */
export const updateSettings = async (updateSettingsRequest: UpdateSettingsRequest, options?: Parameters<typeof customFetch>[1]): Promise<BotSettings> => {
