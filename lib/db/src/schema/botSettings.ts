...
export const botSettingsTable = pgTable("bot_settings", {
  ...
  // Bumped when the margin-based exit defaults (TP 10% / SL 50% of margin)
  // must be force-applied once to an existing database row.
  marginExitDefaultsVersion: integer("margin_exit_defaults_version").notNull().default(1),
