...
export const signalsTable = pgTable("signals", {
  ...
  epic:             text("epic").notNull(),    // Bybit symbol
  market:           text("market").notNull(),  // Human name
  ...
  // Institutional order-flow evidence captured at signal time
  orderFlowScore:   real("order_flow_score"),
  orderFlowBias:    text("order_flow_bias"),
  orderFlowNotes:   text("order_flow_notes"),
});
